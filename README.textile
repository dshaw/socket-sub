...
This needs to happen on a server that is NOT behind a firewall. PubSubHubbub is a server-to-server protocol. It won't work on your local machine. You can certainly try to use the wonderful "Localtunnel":http://github.com/progrium/localtunnel/ from "@progrium":http://twitter.com/progrium
